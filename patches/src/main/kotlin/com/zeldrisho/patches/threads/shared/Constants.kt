package com.zeldrisho.patches.threads.shared
...
object Constants {
    /** Tested build: APKMirror versionCode 510406926 (APKMirror ships the same
     * version name with versionCode 510406907 on APKPure — smali matched, but re-verify
