...
Incident-driven context, distilled from a sibling Morphe patch bundle
(`chiggi_morphe_patches`, see its `RULEBOOK.md`) and from this repo's Threads
work. Each rule earned its place because an incident cost someone something —
